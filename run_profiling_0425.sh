...
PROFILE_BASE="${SCRIPT_DIR}/profiling_0425"
...
echo "    no_lora/ — Base model profiling traces + Perfetto-compatible"
echo "    lora/    — LoRA model profiling traces + Perfetto-compatible"
echo ""
